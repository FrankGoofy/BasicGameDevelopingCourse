...
HBITMAP T_Engine::CreateBlankBMP(HDC hDC, int ibWidth, int ibHeight, COLORREF crColor)
{
	//创建一个空的位图
...
BOOL T_Engine::LoadBmp(const WCHAR* path)
{
...
HBITMAP T_Engine::CreateBlankBMP(int ibWidth, int ibHeight, COLORREF crColor)
{
